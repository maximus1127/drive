                    ...
                    <div class="card border-info">
                        ...
                        <form method="post" action= '{{ route('createClass')}}'>
                            ...
                            <h3 class="card-title d-inline">
                                <i class="fa fa-fw fa-calendar"></i> Schedule A New Class
                            </h3>
                            @php(
                            ...
                            <div class="box-body row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <div class="input-group  ">
                                        <input type="text" class="form-control" id="datetimepicker1" name="day_1" value=''>
                                ...
                                <div class="form-group col">
                                    ...
                                    <div class="input-group  ">
                                        <input type="text" class="form-control" id="datetimepicker1_2" name="day_2" value="">
                                        <span class="input-group-addon">
                                                <i class="fa fa-fw fa-calendar"></i>
                                            </span>
                                ...
                                <div class="form-group col">
                                    ...
                                    <div class="input-group  ">
                                        <input type="text" class="form-control" id="datetimepicker1_3" name="day_3">
                                        <span class="input-group-addon">
                                                <i class="fa fa-fw fa-calendar"></i>
                                            </span>
                                ...
                                <div class="form-group col">
                                    ...
                                    <div class="input-group  ">
                                        <input type="text" class="form-control" id="datetimepicker1_4" name="day_4">
                                        <span class="input-group-addon">
                                                <i class="fa fa-fw fa-calendar"></i>
                                            </span>
